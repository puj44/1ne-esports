...
<html lang="en">
<head>
    <title>Code coverage report for server/utils/jsonEncode.test.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\index.html">All files</a> / <a href="index.html">server/utils</a> jsonEncode.test.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  it('should prefix functions with a function prefix', () =&gt;
    expect(jsonEncode(<span class="fstat-no" title="function not covered" >{ fn: <span class="fstat-no" title="function not covered" >() =&gt; </span>{}, function() </span>{} }, 'axxxa')).to.match(/axxxafunction fn\(/g));
&nbsp;
