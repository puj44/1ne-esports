...
<html lang="en">
<head>
    <title>Code coverage report for stringify.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> stringify.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof rep === 'function') {
    value = rep(key, value);
  }
&nbsp;
  switch (typeof value) {
...
<span class="branch-5 cbranch-no" title="branch not covered" >    default: {</span>
      l</span>et <span class="cstat-no" title="statement not covered" >r = `"[${typeof value}]"`;
<span class="cstat-no" title="statement not covered" >      try {</span>
<span class="cstat-no" title="statement not covered" >        r = `${value}`;</span>
      } catch (e) {
        //
      }
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Sun Nov 20 2016 23:56:05 GMT+0200 (GTB Standard Time)
</div>
</div>
